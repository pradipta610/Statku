...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
 ...
 <div class="container-fluid padding-lr">
   ...
   <img src="<?php echo BASE_URL.'/assets/img/Logo.png'?>" alt=""  class="d-inline-block align-top">StatKu</a>
     ...
     <div class="navbar-nav ml-auto">
      ...
      <?php  if(isset($_SESSION['id'])): ?>
       <div class="dropdown">
         ...
         <li><a class="dropdown-item " name="logout-btn" href="<?php echo BASE_URL.'/logout.php'?>">Logout</a></li>
